...
export default function ReceptionPatientsPage() {
  const [patients, setPatients] = useState<{ id: string; firstName: string; lastName: string; phone: string }[]>([]);

  useEffect(() => {
    api<{ patients: { id: string; firstName: string; lastName: string; phone: string }[] }>("/api/patients")
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">Patients</h1>
